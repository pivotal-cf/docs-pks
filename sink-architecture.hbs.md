...
For step-by-step instructions on creating sinks in {{ vars.product_short }},
...
{{ vars.product_short }} deployment and workloads that are running on them.
...
{{ vars.product_short }}-provisioned Kubernetes clusters include an
...
![Observability Manager architecture in {{ vars.product_short }}.](images/manager-architecture.png)
...
![Log sink architecture in {{ vars.product_short }}.](images/log-architecture.png)
...
![Metric Sink architecture in {{ vars.product_short }}.](images/metric-architecture.png)
