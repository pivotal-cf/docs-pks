...
In preparation for installing {{  vars.product }} on vSphere with NSX, review the following documentation:

<ul>
  <li>
    <a href="./vsphere-nsxt-requirements.html">Version Requirements for {{  vars.product }}</a>
  </li>
  <li>
    <a href="./vsphere-nsxt-rpd-mpd.html">Hardware Requirements for {{  vars.product }}</a>
  </li>
  <li>
  ...
  <li>
    <a href="./nsxt-topologies.html">NSX Deployment Topologies for {{  vars.product }}</a>
  </li>
  <li>
    <a href="./vsphere-nsxt-cluster-objects.html">NSX Cluster Objects Created for {{  vars.product }}</a>
  </li>
  <li>
