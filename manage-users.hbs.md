...
user through LDAP, see the [Configuring LDAP integration with VMware Tanzu Application Service (TAS) for VMs](https://knowledge.broadcom.com/external/article/297557/) Knowledge Base article.
