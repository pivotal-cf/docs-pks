...
1. From each ESXi transport node, test the connections to each NSX Edge Node, for example:
    ...
    1. Test the connection from NSX edge node 1 and edge node 2 to ESXi TN:
    ...
    1. Test the connection from NSX edge node 1 to NSX edge node 2:
...
##<a id='nsxt30-edge-cluster'></a> Create NSX Edge Cluster
