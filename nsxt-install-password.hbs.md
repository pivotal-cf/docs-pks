...
This topic describes how to configure NSX passwords after you have installed NSX for {{  vars.product_full }} ({{ vars.product_short }}).
...
<ul>
  ...
  <li>
    <a href="./nsxt-install-edges.html">Deploy NSX Edge Nodes</a>
  </li>
  <li>
...
##<a id='nsxt-password-mgr'></a> Configure the NSX Password Interval (Optional)
...
On Windows, use Putty and provide the IP address for NSX Manager. Enter the user name and password that you defined during the installation of NSX.
...
<p class="note"><strong>Note:</strong> Unlike the NSX Manager nodes, you must update the password or password interval on each Edge Node.</p>
