...
1. Select the **Enable SSH** check box.
1. Select the **Allow SSH root logins** check box.
...
1. Enter the vCenter user name. For example, `administrator@vsphere.local`.
...
Use the NSX-T Management Console to deploy an additional NSX-T Manager node as part of the NSX-T Management layer. For more information, see the [NSX-T documentation](https://techdocs.broadcom.com/us/en/vmware-cis/nsx/vmware-nsx/4-1-2/installation-guide/installing-nsx-manager-cluster-on-vsphere/install-nsx-manager-and-available-appliances/deploy-nsx-manager-nodes-to-form-a-cluster-using-ui.html).
...
Use the NSX-T Management Console to deploy a third NSX-T Manager node as part of the NSX-T Management layer. For more information, see the [NSX-T documentation](https://techdocs.broadcom.com/us/en/vmware-cis/nsx/vmware-nsx/4-1-2/installation-guide/installing-nsx-manager-cluster-on-vsphere/install-nsx-manager-and-available-appliances/deploy-nsx-manager-nodes-to-form-a-cluster-using-ui.html).
...
An SSL certificate is automatically created for each NSX-T Manager.
You must also generate a certificate for the NSX-T Manager VIP.
...
1. Once the process completes, verify the Edge Node 1 deployed successfully in NSX-T Manager.
...
1. Once the process completes, verify the Edge Node 2 deployed successfully in NSX-T Manager.
...
SSH on the Edge Node is deactivated by default. You have to enable SSH on the Edge Node using the Console from vSphere.
