...
[How to Create or Remove Custom VM_TYPE Template using the {{{ vars.platform_name }}} API](https://knowledge.broadcom.com/external/article/297413/) in the Knowledge Base.
