...
### <a id='aws-az-nsx'></a>AWS, Azure, and vSphere with NSX Prerequisites
If you use Amazon Web Services (AWS), Azure, or vSphere with NSX integration, your cloud provider can configure a public-cloud external load balancer for your workload.
See either [Deploy Workloads on vSphere with NSX](#external-lb-nsxt) or [Deploy Workloads on AWS or Azure, Using a Public-Cloud External Load Balancer](#external-lb) below.
