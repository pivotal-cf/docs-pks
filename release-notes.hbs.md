...
## <a id="1-24-0"></a>{{ vars.product_short }} {{{ vars.product_version }}}.0
...
The supported upgrade paths to {{  vars.product }} v1.24.0 is from {{ vars.product_short }} v1.23.x.

### <a id="1-24-0-breaking-changes"></a>Breaking Changes

{{ vars.product_short }} v1.24.0
...
{{ vars.product_short }} v1.24.0 includes the following new features and enhancements:
...
{{ vars.product_short }} v1.24.0 has the following known issues:
...
#### <a id="1-24-0-csi-driver-limits-public-cloud-installing"></a> Installing a Public Cloud CSI Driver on a {{ vars.product_short }} Cluster
...
* For installing the Azure CSI Driver on a {{ vars.product_short }} cluster, {{{ vars.recommended_by }}} recommends you follow the procedure in the [How to install Azure file/disk CSI driver onto TKGI 1.14 cluster](https://knowledge.broadcom.com/external/article/298706/) knowledge base article in the VMware Tanzu Support Hub.

<hr>

#### <a id="1-24-0-csi-driver-limits-public-cloud-managing"></a> Managing a {{ vars.product_short }} Cluster That Uses a Public Cloud CSI Driver
...
#### <a id="1-24-0-containerd-istio"></a> {{ vars.product_short }} version upgrade without new stemcell fails for Containerd runtime clusters with Istio CNI
...
#### <a id="1-24-0-renamed-ops-man"></a> {{ vars.product_short }} MC Unable to Manage {{ vars.product_short }} after Restoring the {{ vars.product_short }} Control Plane from Backup
...
#### <a id="1-24-0-tmc-restic"></a>TMC Data Protection Feature Requires Privileged {{ vars.product_short }} Containers
...
#### <a id="1-24-0-profile-resize-down"></a>{{ vars.product_short }} CLI Does Not Prevent Reducing the Control Plane Node Count
