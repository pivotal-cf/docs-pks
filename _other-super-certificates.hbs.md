...
* **{{  vars.product }} tile**<br>
    The {{  vars.product }} tile uses NSX Manager to create load balancers,
...
{{# evalExpression "current_page.data.authenttype == 'pkstile'"}}
    To configure the **{{  vars.product }}** tile's authentication to NSX Manager, see
...
{{# evalExpression "current_page.data.authenttype == 'pkstile'"}}
    ...
    [Configure vCenter for {{  vars.product }}](vsphere-nsxt-om-config.html#vcenter-config) in _Configuring BOSH Director with NSX for {{  vars.product }}_.<br><br>
{{/ evalExpression }}
{{# evalExpression "current_page.data.authenttype == 'boshtile'"}}
    To configure the **BOSH Director for vSphere** tile's authentication to NSX Manager, see
    [Configure vCenter for {{  vars.product }}](#vcenter-config), below.<br>
{{/ evalExpression }}
