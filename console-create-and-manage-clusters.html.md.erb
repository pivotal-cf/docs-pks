...
- Add users and user groups to VMware Tanzu Kubernetes Grid Integrated Edition, and assign roles to them so that they can create and manage clusters. For information about user management, see [Identity Management in the Management Console](console-identity-management.html).
...
- If a new version of Kubernetes is available, you can [Upgrade Clusters to a New Version of Kubernetes](console-create-clusters.html#upgrade-clusters).
