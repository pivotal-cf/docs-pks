...
1. Create one or more new Pod IP Blocks in NSX Manager.
1. Follow these procedures in _Creating and Managing Network Profiles (NSX Only)_:
    1. [Create a Modified Network Profile Configuration](network-profiles-define.html#create-modified-profile-configuration)
    1. [Create a Modified Network Profile](network-profiles-define.html#create-modified-profile)
    1. [Update the Cluster With a Modified Network Profile](network-profiles-define.html#update-w-modified-profile)
