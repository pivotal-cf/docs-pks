...
1. When the cluster upgrades are complete, run the command `tkgi clusters` and verify that they list the target version:
    ...
    1.22.4        tkgi-cluster-1-small   1.32.14      small      0bea03c8-af47-48e8-b249-814c0bc407b9  succeeded  UPGRADE
    1.22.4        tkgi-cluster-2-medium  1.32.14      medium     5d9f4501-70cb-460b-9d78-0afbc074cb8c  succeeded  UPGRADE
    1.22.4        tkgi-cluster-3-large   1.32.14      large      b448117a-bb6f-49de-bc9b-452588bd44ef  succeeded  UPGRADE
    ```
...
1. Run `tkgi clusters` to verify that the new cluster is created with the appropriate version of TKGI and Kubernetes:
    ...
    $ tkgi clusters
    TKGI Version  Name                   k8s Version  Plan Name  UUID                                  Status     Action
    1.22.4        tkgi-cluster-4-test    1.32.14      medium     5d9f4501-70cb-460b-9d78-0afbc074cb8c  succeeded  CREATE
    1.22.4        tkgi-cluster-1-small   1.32.14      small      0bea03c8-af47-48e8-b249-814c0bc407b9  succeeded  UPGRADE
    1.22.4        tkgi-cluster-2-medium  1.32.14      medium     5d9f4501-70cb-460b-9d78-0afbc074cb8c  succeeded  UPGRADE
    1.22.4        tkgi-cluster-3-large   1.32.14      large      b448117a-bb6f-49de-bc9b-452588bd44ef  succeeded  UPGRADE
    ```
