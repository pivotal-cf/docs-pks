...
* [Upgrade Clusters](#upgrade-clusters)
  ...
  * [Upgrade Multiple Clusters (1)](#upgrade-clusters-multi)
    * [Upgrade Clusters in Parallel (2)](#upgrade-clusters-parallel)
...
1. If you have not already done so, install the TKGI CLI for the
current TKGI version. For information,
...
1. Download [Velero {{{ vars.velero_version }}}](https://support.broadcom.com/group/ecx/productfiles?subFamily=Tanzu+Kubernetes+Grid+Integrated+Edition+(TKGi)+-+Mgmt+Console&displayGroup=Tanzu+Kubernetes+Grid+Integrated+Edition+(TKGi)%20-+Mgmt+Console&release=1.20&os=&servicePk=523023&language=EN) from Broadcom Support.
