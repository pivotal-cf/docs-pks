...
1. Run the following command to view additional details of an individual cluster, including NSX network details and Kubernetes settings details:
    ...
    <img src="images/nsxt/pks-cli-network-details.png" alt="View NSX Network Details" width="725">
