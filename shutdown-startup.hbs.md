...
This topic describes how to shut down and startup VMware Tanzu Kubernetes Grid Integrated Edition (TKGI), 
...
###<a id="shutdown-nsxt"></a>Step 9: Shut Down NSX Components (vSphere NSX Only)

Using vCenter, gracefully shut down all NSX VMs in the following order:

1. NSX Manager
1. NSX Controllers
1. NSX Edge Nodes

<img src="images/nsxt/shutdown/shutdown-nsxt.png" alt="Shut Down NSX VMs">
...
For more information about how to shut down the vCenter Server VM, see [Reboot or Shut Down the vCenter Server Appliance](https://techdocs.broadcom.com/us/en/vmware-cis/vsphere/vsphere/7-0/configuring-vcenter-server-7-0/configuring-vcenter-server-using-the-management-interface/reboot-or-shut-down-vcenter-server.html) in the vSphere documentation
and the [How to stop, start, or restart vCenter Server 6.x services](https://knowledge.broadcom.com/external/article?legacyId=2109881) KB article.
...
###<a id="shutdown-esxi"></a>Step 11: Shut Down ESXi Hosts (vSphere NSX Only)
...
###<a id="start-nsxt"></a> Step 3: Start NSX Components (vSphere NSX Only)

To start the NSX components, perform the following steps:
