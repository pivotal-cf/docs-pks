...
For information about the tasks that Cluster Managers can perform, see [Tanzu Kubernetes Grid Integrated Edition Architecture](./control-plane.html). The TKGI Administrator role allows users to manage the Tanzu Kubernetes Grid Integrated Edition infrastructure. 
...
<p class="note"><strong>Note</strong>: This release of Tanzu Kubernetes Grid Integrated Edition Management Console does not support assigning roles to individual LDAP or SAML users. To assign roles to LDAP or SAML users, use user groups.</p>
