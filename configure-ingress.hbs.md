...
This topic describes how to configure an ingress controller on {{  vars.product_full }}.
...
- A TKGI-deployed cluster with its own load balancer. See [Creating Clusters](create-cluster.html).
