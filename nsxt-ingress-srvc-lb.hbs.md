...
This topic describes example ingress routing (Layer 7) and load balancing (Layer 4) configurations for Kubernetes clusters deployed by {{  vars.product_full }} on vSphere with NSX integration.
