...
For more information, see [Compute Profiles vs. Plans](compute-profiles-manage.html#vs-plans).
...
1. Click **Add Availability Zones** to create a new availability zone for the compute profile.

   1. Enter a name for the availability zone.
   1. Enter the name of an existing data center, cluster, resource pool, and host group.
