...
* [Backup the Guestbook App Using Label (1)](#guestbook-br-ns)
* [Restore the Guestbook App Using Label (2)](#guestbook-br-ns)
* [Conclusions](#guestbook-conclusions-label)
...
Verify: Verify that all pods in the application have the same `guestbook` label:
