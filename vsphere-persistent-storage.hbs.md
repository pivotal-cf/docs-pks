...
**Limitations**: See [Guidelines/Limitations for Cloud Native Storage (CNS) Relocate on vSphere and known issues](https://knowledge.broadcom.com/external/article?legacyId=90607) in the Broadcom Support Knowledge Base.

**Migration procedures**:

* **vSphere 8.0 U2** and later: [Migrating Container Volumes in vSphere](https://techdocs.broadcom.com/us/en/vmware-cis/vsphere/vsphere/7-0/vsphere-storage-7-0/getting-started-with-cloud-native-storage-in-vsphere/cloud-native-storage-for-vsphere-administrators/migrating-container-volumes-in-vsphere.html).
* **vSphere 7.0 U3o** and later: [Migrating Container Volumes in vSphere](https://techdocs.broadcom.com/us/en/vmware-cis/vsphere/vsphere/7-0/vsphere-storage-7-0/getting-started-with-cloud-native-storage-in-vsphere/cloud-native-storage-for-vsphere-administrators/migrating-container-volumes-in-vsphere.html)
