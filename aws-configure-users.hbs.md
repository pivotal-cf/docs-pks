---
title: Setting Up {{  vars.product }} Admin Users on AWS

iaas: AWS
---

This topic describes how to create {{  vars.product_full }} admin users with User Account and Authentication (UAA).
