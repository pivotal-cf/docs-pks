...
This topic describes how to set up the VMware Harbor Registry (Harbor) image registry for {{  vars.product_full }}.
...
you can activate or deactivate user self-registration.
