...
NSX Data Center provides in-product back up and recovery that supports back up and restore of the NSX Manager Nodes. For more information, see [Backing Up and Restoring NSX Manager](https://techdocs.broadcom.com/us/en/vmware-tanzu/standalone-components/tanzu-kubernetes-grid-integrated-edition/1-19/tkgi/backup-and-restore-nsxt.html) in the NSX documentation.
...
https://techdocs.broadcom.com/us/en/vmware-cis/nsx/nsxt-dc/3-2/administration-guide/backing-up-and-restoring-the-nsx-manager/restore-a-backup.html) in the NSX Data Center documentation.
