...
This topic describes how HTTP/HTTPS proxies work in VMware Tanzu Kubernetes Grid Integrated Edition (TKGI) on AWS,
...
If your environment includes HTTP proxies, you can configure Tanzu Kubernetes Grid Integrated Edition
on AWS to use these proxies so that Tanzu Kubernetes Grid Integrated Edition-deployed Kubernetes
...
1. Click **Networking**.
1. Under **HTTP/HTTPS Proxy**, select **Enabled** to configure an Tanzu Kubernetes Grid Integrated Edition global proxy
