...
the {{ vars.product_short }} API VM behind a proxy is able to manage AWS components on the standard network.
...
<br>
    <img src="images/proxy-arch-global.png" alt="{{ vars.product_short }} Proxy Architecture">
...
1. To save your changes to the {{ vars.product_short }} tile, click **Save**.
