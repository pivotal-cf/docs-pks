...
This topic describes how to install and configure NSX Managers on vSphere in a clustered arrangement for high-availability for {{  vars.product_full }}.
...
##<a id='nsxt30-mgr1'></a> Deploy NSX Manager 1
...
1. Enable the **Enable SSH** check box.
1. Enable the **Allow SSH root logins** check box.
  <img src="images/nsxt/nsxt-30/nsx-manager-1-10.png">
1. Click **Finish**, and NSX Manager 1 starts deploying.
...
1. Access the NSX Manager 1 web console by navigating to the URL, such as: `https://10.173.62.44/`.
...
1. Enter the vCenter user name, such as `administrator@vsphere.local`.
...
##<a id='nsxt30-mgr2'></a> Deploy NSX Manager 2
...
1. Verify that the NSX Manager 2 appliance is added.
...
##<a id='nsxt30-mgr3'></a> Deploy NSX Manager 3
...
1. Enter a strong password.
1. Click **Install Appliance**.
1. Verify that the NSX Manager 3 appliance is added.
  <img src="images/nsxt/nsxt-30/nsx-manager-1-27.png">
  <img src="images/nsxt/nsxt-30/nsx-manager-1-28.png">

##<a id='nsxt30-mgmt-vip'></a> Configure the NSX Management VIP
