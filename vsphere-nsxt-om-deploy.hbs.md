---
title: Deploying {{ vars.platform_name }} with VMware NSX for Tanzu Kubernetes Grid Integrated Edition
...
Before deploying {{ vars.platform_name }} with NSX for Tanzu Kubernetes Grid Integrated Edition, you must have completed the following tasks:
...
In addition, review the supported {{ vars.platform_name }} versions for Tanzu Kubernetes Grid Integrated Edition.
...
## <a id="deploy-om"></a>Step 2: Deploy {{ vars.platform_name }} for Tanzu Kubernetes Grid Integrated Edition

1. Before starting, refer to the [Tanzu Kubernetes Grid Integrated Edition Release Notes](release-notes.html) for supported {{ vars.platform_name }} versions for Tanzu Kubernetes Grid Integrated Edition.
...
## <a id="config-om"></a>Step 3: Configure {{ vars.platform_name }} for Tanzu Kubernetes Grid Integrated Edition
