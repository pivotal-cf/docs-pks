...
When you run `tkgi get-credentials CLUSTER-NAME`, TKGI sets the context to the cluster you provide as the `CLUSTER-NAME`.
TKGI binds your user name to the cluster and populates the kubeconfig file on your local workstation with cluster credentials and configuration.
