...
This topic describes how to define a network profile to configure shared and dedicated Tier-1 router topologies for {{  vars.product_full }} provisioned Kubernetes clusters on vSphere with NSX.
...
* 1 Logical Switch and Tier-1 Router each NSX Load Balancer that is allocated for the Kubernetes cluster
