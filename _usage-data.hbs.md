Tanzu Kubernetes Grid Integrated Edition-provisioned clusters send usage data to the TKGI control plane for storage. 
...
{{# evalExpression "current_page.data.thistopic =='wizard'"}}
  ![CEIP program description](./images/ceip-telemetry-descrip.png)  
  [View a larger version of this image.](./images/ceip-telemetry-descrip.png)  
{{ else }}
  ![CEIP program description](./images/ceip-telemetry-descrip.png)  
  [View a larger version of this image.](./images/ceip-telemetry-descrip.png)  
{{/ evalExpression }}
1. If you wish to participate in CEIP, select **Yes**. Otherwise, select **No**.
1. If you selected the **Yes**, complete the following:
