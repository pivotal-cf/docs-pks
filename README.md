...
|-----------------|-------------|--------------|
| `master` | PKS 1.3.x released content | https://docs.pivotal.io/runtimes/pks/1-3/index.html |
...
The `master` branch is used to publish the live v1.3 version of the site. Create pull requests on `master` to contribute bug fixes or correct technical inaccuracies in the v1.3 documentation. 
