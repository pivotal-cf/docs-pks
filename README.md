...
|-----------------|-------------|--------------|
| `master` | PKS 1.4.x content (in development) | N/A |
...
The `master` branch is used to develop the v1.4 version of the PKS documentation. Create pull requests on `master` to contribute bug fixes or correct technical inaccuracies in the v1.4 documentation.
