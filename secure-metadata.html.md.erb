...
from Kubernetes clusters created with VMware Tanzu Kubernetes Grid Integrated Edition (TKGI).  
...
For information on why it is recommended that you secure access to AWS instance metadata, see 
