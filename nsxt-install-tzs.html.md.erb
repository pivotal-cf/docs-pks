...
match exactly the **Edge Switch Name** value that you specify when you configure an NSX Edge Node for use with TKGI.
...
<p class="note"><strong>Note:</strong> In NSX 3.1 and later, the Transport Zone Host Switch Name has been deprecated and removed from the NSX configuration UI. 
  For more information, see <a href="#nsxt31-edge-config">TKGI NSX Edge Switch and Transport Zone Host Switch Name Requirements</a>.</p> 

##<a id='option1'></a> Configure Your NSX Transport Zones for TKGI

TKGI requires the NSX **Edge Switch Name** and the Transport Zone host switch name to be identical.
...
##<a id='nsxt31-edge-config'></a> TKGI NSX Edge Switch and Transport Zone Host Switch Name Requirements 

In NSX 3.1 and later, the Transport Zone Host Switch Name has been deprecated and removed from the NSX configuration UI.  

For TKGI, the NSX **Edge Switch Name** and the Transport Zone host switch name must be identical. 
