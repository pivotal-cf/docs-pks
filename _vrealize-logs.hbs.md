...
<p class="note"><strong>Note</strong>: The {{  vars.product }} tile does not validate your vRLI configuration settings. To verify your setup, look for log entries in vRLI.</p>
