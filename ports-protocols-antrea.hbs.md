...
{{{ vars.recommended_by }}} recommends that you enable access to the apps through the standard Kubernetes load-balancers and ingress controller types, instead of using a Kubernetes NetworkPolicy to filter traffic between networks and TKGI system components and clusters.
