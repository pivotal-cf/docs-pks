...
This topic describes how to create a load balancer for the {{  vars.product_full }} API (TKGI API) using Amazon Web Services (AWS). Refer to the procedures in this topic to create a load balancer by using AWS.
